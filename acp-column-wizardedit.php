 ...
 * --------------------------------------------
 */
class ACP_Column_wizardedit extends AC_Column_wizardedit
	implements \ACP\Editing\Editable, \ACP\Sorting\Sortable, \ACP\Export\Exportable {

	public function editing() {
		return new ACP_Editing_Model_wizardedit( $this );
	}

	public function sorting() {
		return new ACP_Sorting_Model_wizardedit( $this );
	}

	public function export() {
		return new ACP_Export_Model_wizardedit( $this );
	}
 ...
 */
class ACP_Editing_Model_wizardedit extends \ACP\Editing\Model {
 ...
 */
class ACP_Sorting_Model_wizardedit extends \ACP\Sorting\Model {
 ...
 */
class ACP_Export_Model_wizardedit extends \ACP\Export\Model {
